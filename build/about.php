        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav ms-auto py-0">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Login Here</a>
    ...
    <div class="container">
      <div class="row gx-5">
        ...
        <div class="col-lg-7">
          ...
          <p>
            The best medical care for yourself and your family involves a
            comprehensive approach to maintaining and improving health. It
            includes regular check-ups with a trusted healthcare provider, a
            focus on preventive care, and prompt attention to any health
            concerns. This approach aims to address both physical and mental
            well-being, emphasizing healthy lifestyle choices, early detection
            and treatment of medical issues, and open communication with
            healthcare professionals. The best medical care ensures that you
            and your family receive the support and guidance needed to lead
            healthy and fulfilling lives while also addressing any medical
      ...
      <div class="owl-carousel team-carousel position-relative">
          ...
          <div class="row g-0 bg-light rounded overflow-hidden">
            ...
            <div class="col-12 col-sm-7 h-100 d-flex flex-column">
              <div class="mt-auto p-4">
                <h4>Dr. Sivakumar S. MS, MCH</h4>
                <h6 class="fw-normal fst-italic text-primary mb-4">
                  Orthopaedist Specialist
                </h6>
                <p class="m-0">
                  Dr. Sivakumar is a senior consultant with years of
                  experience in Orthopaedist. His areas of interest include
                  cerebrovascular surgery, skull base surgery and spine
                  surgery, trauma and non‐trauma.
                </p>
              </div>
        ...
        <div class="team-item">
          <div class="row g-0 bg-light rounded overflow-hidden">
            ...
            <div class="col-12 col-sm-7 h-100 d-flex flex-column">
              <div class="mt-auto p-4">
                <h4>Dr. Ajith K MBBS, MD, FNB</h4>
                <h6 class="fw-normal fst-italic text-primary mb-4">
                  Senior Consultant
                </h6>
                <p class="m-0">
                  Dr. Ajith K Gopal is a senior consultant With over 15 years
                  experience and critical care. This invaluable expertise has
                  been honed through working in wide range of multispecialty
                  hospitals
                </p>
              </div>
              <div class="d-flex mt-auto border-top p-4">
        ...
        <div class="team-item">
          <div class="row g-0 bg-light rounded overflow-hidden">
            ...
            <div class="col-12 col-sm-7 h-100 d-flex flex-column">
              <div class="mt-auto p-4">
                <h4>Dr. Ashly Shino P MBBS, DrNB</h4>
                <h6 class="fw-normal fst-italic text-primary mb-4">
                  Neurosurgery Specialist
                </h6>
                <p class="m-0">
                  Dr. Ashly Shino P is a Senior Neurosurgery with extensive
                  experience in medical college service and private
      ...
      <div class="row g-5">
        <div class="col-lg-3 col-md-6">
          ...
          <p class="mb-2">
            ...
            CHELANNUR NEETHI LABS AND SCANS (PO) Chelannur HO Kakkodi Mukku
            Calicut -673616 Kerala <br>Mon-sat: 9am-5pm</br> Sunday: Closed
          </p>
          <p class="mb-2">
            <i class="fa fa-envelope text-primary me-3"></i>info@neethihospital.org
          </p>
          <p class="mb-0">
            <i class="fa fa-phone-alt text-primary me-3"></i>+91-495-2723272
          </p>
        </div>
        <div class="col-lg-3 col-md-6">
          <h4 class="d-inline-block text-primary text-uppercase border-bottom border-5 border-secondary mb-4">
    ...
    <div class="container">
      <div class="row g-5">
        <div class="col-md-6 text-center text-md-start">
          <p class="mb-md-0">
            &copy; <a class="text-primary" href="#">www.info@neethihospital.com</a>. All
            Rights Reserved.
          </p>
        </div>
