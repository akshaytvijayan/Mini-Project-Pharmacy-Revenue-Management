      ...
      <div class="row gx-5">
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <p class="text-white mb-5">
            Families can ensure they receive regular check-ups and timely
            healthcare, promoting overall well-being and early detection of
            health issues. Making appointments for routine exams,
            vaccinations, and consultations with healthcare providers is a
            responsible and caring step to safeguard the health of every
            family member, maintaining a healthy and happy lifestyle.
          </p>
          ...
          <div class="bg-white text-center rounded p-5">
            ...
            <form>
              <div class="row g-3">
                ...
                <div class="col-12 col-sm-6">
                  <select class="form-select bg-light border-0" style="height: 55px">
                    <option selected>--Search By Doctor--</option>
                    <option value="1">
                      Dr. Ajith K Gopal MBBS, MD, FNB ( General Medicine)
                    </option>
                    <option value="2">
                      Dr. Ashly Shino P Associate Consultant MBBS, DrNB (
                      Neurosurgery )
                    </option>
                    <option value="3">
                      Dr. Sivakumar S. MS, MCH ( Orthopaedist )
                    </option>
                  </select>
                </div>
                <div class="col-12 col-sm-6">
                ...
                <div class="col-12 col-sm-6">
                  <div class="time" id="time" data-target-input="nearest">
                    <select class="form-select bg-light border-0" style="height: 55px">
                      <option selected>--Search Time Solt--</option>
                      <option value="1">09:00 am - 10:00 am</option>
                      <option value="2">10:00 am - 11:00 am</option>
                      <option value="3">11:00 am - 12:30 pm</option>
                      <option value="4">01:30 pm - 02:30 pm</option>
                      <option value="5">02:30 pm - 03:30 pm</option>
                      <option value="6">03:30 pm - 04:30 pm</option>
                    </select>
                  </div>
                </div>
                <div class="col-12">
