      ...
      <div class="row g-5 mb-5">
        <div class="col-lg-4">
          <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center text-center" style="height: 200px">
            <div class="d-flex align-items-center justify-content-center bg-primary rounded-circle mb-4" style="width: 100px; height: 70px; transform: rotate(-20deg)">
              <i class="fa fa-2x fa-location-arrow text-white" style="transform: rotate(20deg)"></i>
            </div>
            <h6 class="mb-0">
              CHELANNUR NEETHI LABS AND SCANS <br>(PO) Kakkodi Mukku via</br>
              Calicut -673616, Kerala</h6>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center text-center" style="height: 200px">
            ...
            <h6 class="mb-0">+91-495-2723272</h6>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center text-center" style="height: 200px">
            ...
            <h6 class="mb-0">info@neethihospital.org</h6>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12" style="height: 500px">
          <div class="position-relative h-100">
            <iframe class="position-relative w-100 h-100" src="https://www.google.com/maps/place/Neethi+Medical+Store/@11.3180316,75.7990709,18z/data=!4m14!1m7!3m6!1s0x3ba65e7c3aaa472d:0xaaefef9d878dd61a!2sNeethi+Medical+Store!8m2!3d11.3178659!4d75.8003584!16s%2Fg%2F12604sbsd!3m5!1s0x3ba65e7c3aaa472d:0xaaefef9d878dd61a!8m2!3d11.3178659!4d75.8003584!16s%2Fg%2F12604sbsd?entry=ttu" frameborder="0" style="border: 0" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </div>
        </div>
      </div>
      ...
      <div class="row g-5">
        <div class="col-lg-3 col-md-6">
          ...
          <p class="mb-2">
            ...
            CHELANNUR NEETHI LABS AND SCANS (PO) Chelannur
            HO Kakkodi Mukku Calicut -673616 Kerala
            <br>Mon-sat: 9am-5pm</br> Sunday: Closed
          </p>
          <p class="mb-2">
